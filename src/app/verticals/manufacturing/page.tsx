...
const manufacturingHeroTexts = {
  ...
  description: `At the forefront of Industry 4.0, Neurologic AI enables manufacturers to revolutionize
operations by integrating cutting-edge artificial intelligence and advanced simulations. We
leverage industry leading tools like NVIDIA Omniverse to deliver physics-accurate virtual
testing, sensor simulation, and synthetic data generation. Our expertise helps manufacturers
overcome complex challenges in product inspection, sustainable recycling practices,
intelligent material classification, and robotic automation. By utilizing multi-stage intelligent
frameworks for automated defect detection and autonomous AI-powered robots for precise
tasks like RFID scanning, we drive significant improvements in efficiency, agility, and
sustainability. Our solutions are designed to streamline manufacturing processes, accelerate
deployment, reduce operational costs, and significantly shorten time-to-market, ensuring
manufacturers stay competitive in an ever-evolving market.`,
};
