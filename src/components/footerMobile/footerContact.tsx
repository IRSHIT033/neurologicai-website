    ...
    <div className="w-full text-white px-4 py-6">
      ...
      <div className="w-full flex justify-between items-center text-[#B3B3B3] text-sm pb-4">
        ...
        <div className="flex items-center gap-2">
          <Image src="/location_image.png" alt="Location" width={20} height={20} className="w-[40px] h-[40px]" />
          <p className="text-xs leading-[16px]">
            254 Chapman Rd, Ste 208<br />
            #17957, Newark, Delaware<br />
        ...
        <div className="flex items-center gap-2">
          <Image src="/mail.png" alt="Email" width={20} height={20} className="w-[25px] h-[25px]" />
