...
const FlipCard = ({ className, frontSrc, backSrc, alt }) => {
      ...
      >
        ...
        >
          ...
          <div className="absolute w-full h-full backface-hidden">
            <Image src={frontSrc} alt={alt} layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
  
          {/* Back Side */}
          <div className="absolute w-full h-full rotate-y-180 backface-hidden">
            <Image src={backSrc} alt={`${alt} - Back`} layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
        </motion.div>
      </div>
    );
...
export default function HealthcareSection() {
  return (
    <section className="py-16 px-24 bg-black flex items-start">
      ...
      <div className="grid grid-cols-[196px_619px] ml-30 grid-rows-[auto_auto] gap-x-2 gap-y-2 max-w-[850px] flex-grow">
        ...
        <div className="row-span-2 grid grid-rows-[auto_auto_auto] gap-y-2">
          ...
          <div className="flex items-center justify-center">
            <Image src="/healthcare/icon-top.png" alt="Healthcare Icon" width={196} height={71} className="object-contain" />
          </div>
        ...
        <div className="grid grid-cols-[417px_196px] grid-rows-[auto_auto] gap-x-2 gap-y-2">
          ...
          <div className="flex items-center justify-start">
            <Image src="/healthcare/icon-bottom.png" alt="Healthcare Icon" width={196} height={62} className="object-contain" />
          </div>
