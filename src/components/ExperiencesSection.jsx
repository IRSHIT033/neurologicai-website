...
const experiences = [
  ...
  { text: "Multi-Stage Agentic Framework Powered By VLM And Knowledge Graphs For Product’s Damage Assessment And Recycling", height: "h-[220px]" },
  { text: "SLM-Powered Findings Extraction From Medical Reports Using PHI4", height: "h-[220px]" },
...
export default function ExperiencesSection() {
  return (
    <section className=" mb-30 flex flex-col items-center text-center  relative w-full">
      ...
      {/* Section Heading */}
      <h2 className="w-[986px] h-[319px] flex flex-col justify-center flex-shrink-0 text-center 
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-8 max-w-[1300px]">
        ...
        {experiences.map((experience, index) => (
          <div
            key={index}
            className={`relative w-[600px] ${experience.height || "h-[180px]"} flex-shrink-0 bg-[#14161A] rounded-[12px] flex flex-col justify-center cursor-pointer 
