...
const PartnershipSection = () => {
  return (
    <section className="text-white  text-center pb-8 md:pb-0 my-8 bg-background">
      ...
      <p className="text-[#B3B3B3] text-[12px] md:text-[14px]lg:text-[16px] leading-[18px] md:leading-[31px] mb-8 max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto text-center ">
