...
const PartnershipSection = () => {
  return (
    <section className="text-white  text-center pb-8 md:pb-0 my-8 bg-background px-5 py-4 lg:px-8">
      ...
      <p className="text-[#B3B3B3] text-[12px] md:text-[14px]lg:text-[16px] leading-[18px] md:leading-[31px] mb-8 w-full sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto text-center ">
      ...
      <div className="flex flex-row items-center justify-center gap-8 md:gap-20 w-full">
        <div className="w-[130px] h-[45px] md:w-[180px] md:h-[67px] flex-shrink-0 bg-lightgray rounded-[10px] relative">
          <Image
            src="/gcp.svg"
            alt="GCP Logo"
            layout="fill"
