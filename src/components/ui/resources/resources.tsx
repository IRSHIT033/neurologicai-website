...
export default function Resources(){
    const blogs = [
        {
          id: 1,
          category: "Healthcare",
          image: "/resourcesCard-3.png", // Replace with actual image URL
        ...
        },
        {
          ...
          image: "/resourcesCard-2.png", // Replace with actual image URL
          title: "Hosting a Hugging Face Model on AWS SageMaker",
          description:
            "When fine-tuning a Hugging Face model, it often saves as LoRA adapters.",
        },
        {
          id: 3,
          category: "Retail",
          image: "/resourcesCard-1.png", // Replace with actual image URL
          title: "Hosting a Hugging Face Model on AWS SageMaker",
          description:
            "When fine-tuning a Hugging Face model, it often saves as LoRA adapters.",
        },
    ...
    const publications = [
        ...
        {
          title: "When fine-tuning a Hugging Face model, it often saves as LoRA adapters",
          content: "Explanation of fine-tuning Hugging Face models and LoRA adapters...",
        },
        {
        ...
        <div>
            <section className="py-[5vh] px-[5vw]">
                <div className="py-8">
                    ...
                    <div className="px-6 py-6 w-[50%] mt-9">
                        <div className="mt">
                            <span className="bg-[#0328EE] text-white px-3 py-2 rounded-full text-xs">FEATURED</span>
                            <h1 className="text-[24px] md:text-3xl font-bold mt-6">
                            Hosting a Hugging Face Model on AWS SageMaker: A Step-by-Step Guide
                            </h1>
                        </div>
                        <div className="text-gray-200 mt-8 text-[22px] w-[75%] leading-7">
                            <p >
                            Hugging Face models are powerful tools for NLP, vision, and other machine learning tasks.
                            </p>
                        </div>
                    </div>
                    <div className="">
            ...
            <section className="py-[2vh] px-[5vw] mb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[6vw] mt-6">
                    ...
                    filteredBlogs.map((blog) => (
                        ...
                        <div className="py-4 px-6 text-white mb-4">
                            <div className="w-[92%]">
                                ...
                                <p className="text-gray-200 text-[17px] mt-6">{blog.description}</p>
                            </div>
                    ...
                    <p className="text-gray-400 text-center col-span-3">No blogs found.</p>
                    )}
                </div>
                <p className="text-white text-[15px] font-bold text-right mt-16 cursor-pointer">Show More <span className="align-middle">{'>'}</span> </p>
                {/* </div> */}
            </section>
            ...
            <div className="flex flex-row justify-between">
                    ...
                    <div className="flex  mb-6"> 
                        <button className="border-[#8875D8] border-[1px] text-[#8875D8] rounded-lg text-[22px] h-[40px] px-4">
                ...
                <div className="space-y-3 mt-2">
                    ...
                    <div key={index} className="bg-gradient-to-b from-[#1F3A9A70] via-[#460bc470] to-[#4B0082] rounded-b-lg border-[#3c1ec2] border-[1px] border-t-0">
                        <button
                        onClick={() => toggleAccordion(index)}
                        className="w-full flex justify-between items-center text-right px-6 py-3 font-bold text-xl"
                        >
                        <div className="" >{item.title}</div>
                        <div className="text-4xl">{openIndex === index ? '-' : '+' }</div>
                        </button>
                    ...
                    <div className="py-6 flex flex-row justify-between items-center">
                        ...
                        <div className="w-[50%] leading-tight flex flex-row gap-4 items-center">
                            <div className="p-5 rounded-2xl bg-white flex flex-col items-center">
                                ...
                                <img src="/vectorTop.png" className="h-[2.5vh] w-[5vw]" ></img>
                                <img src="/vectorBase.png" className="h-[2.5vh] w-[5vw] mt-[-1vh]"></img>
                            </div>
                            <div className="ml-1">
                                <p className="text-[38px] font-bold">Subscribe to our Neurologic AI’s news weekly newsletter!</p>
                            </div>
                        </div>
                       <div className="bg-white rounded-4xl px-4 py-2 h-[25%]">
                            <input type="email" placeholder="Enter email address" className="px-4 py-2 rounded-full border-none w-64 text-gray-900 focus:ring-0 focus:outline-none" />
                            <button className="bg-[#0328EE] text-white px-6 py-2 rounded-full">Subscribe</button>
                       </div>
