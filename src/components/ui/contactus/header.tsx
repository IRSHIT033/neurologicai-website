const ContactUsHeader = () => {
  return (
    <div className="w-screen flex flex-col items-center justify-center text-center pt-[2vh] md:pt-[4vh] lg:pt-[5vh]">
      <h1 className="text-6xl poppinsTextMedium  mb-4 bg-gradient-to-r from-blue from-40% to-primary  bg-clip-text text-transparent ">
        Get in touch
      </h1>
      <p className="text-lg text-center max-w-lg leading-8  mb-16 mx-4 lg:mx-auto">
