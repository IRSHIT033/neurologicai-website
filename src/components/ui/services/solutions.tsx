    ...
    <section className=" relative py-16 px-8 bg-black text-white flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-32 gap-y-8 max-w-6xl mx-auto justify-items-center">
        {solutions.map((solution, index) => (
          <div
            key={index}
            className={`${solution.width || "w-[400px]"} ${
              solution.height || "h-[380px]"
            } rounded-[14px] bg-gradient-to-r from-[rgba(3,40,238,0.82)] via-[rgba(62,48,221,0.55)] to-[rgba(121,57,204,0.61)] p-6 flex flex-col items-center justify-center text-center shadow-lg relative`}
          >
