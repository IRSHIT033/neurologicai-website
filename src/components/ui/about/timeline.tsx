...
const timelineData = [
  { year: "2021", details: ["Idea of Neurologic, as a new age AI/ML based startup, was formed"] },
  { year: "2022", details: ["Started Neurologic", "First client, RoutineAI, acquired"] },
  { year: "2023", details: ["Jon Gilotte joined as co-founder", "Revenue growth of 150% since 2022"] },
  { year: "2024", details: ["Revenue growth of 367% from yr2", "Excellence in Healthcare Award at Health 2.0 Conference, Dubai", "Neurologic receives Times Business Award"] },
      ...
      {timelineData.map((item, index) => (
        <motion.div
          ...
          className={`w-[180px] h-[300px] flex flex-col ${
            ...
            index % 2 === 0 ? "translate-y-[-38px]" : "translate-y-[calc(-100%+42px)]"
          }`}
        >
          ...
          <div className={twMerge('py-2',index % 2 === 0 ? "rotate-180" : "")}>{svgDown}</div>
