...
export default function WhoWeAreHeader() {
  return (
    <div className="flex flex-col justify-center items-center my-8">
      <h2 className=" font-poppins text-6xl md:text-[64px] font-bold leading-normal tracking-[-1.28px] text-transparent bg-clip-text bg-gradient-to-r from-[#5025FF] via-[#5A138E] to-[#F5F5F5]">
        Who We Are
      </h2>
