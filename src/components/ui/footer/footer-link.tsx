...
export default function FooterNavigation() {
  return (
    <div className="sm:grid grid-cols-2 md:grid-cols-3 gap-16 md:gap-24 px-4 sm:px-6 md:ml-48 lg:ml-32 text-center md:text-left">
      ...
      <div className="md:ml-16 grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-24 mt-10 md:mt-0">
      ...
      <div className="ml-4 sm:ml-8 mt-4 md:ml-10 col-start-4 row-start-2 flex justify-center items-center md:col-start-5 md:row-start-2 sm:col-start-auto sm:row-start-auto sm:w-full">
