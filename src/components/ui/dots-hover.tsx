  ...
  const dots = [
    {
      ...
      position: "top-[50%] left-[25%] -translate-x-1/2 -translate-y-1/2",
    },
    {
      id: 2,
      ...
      position: "top-[60%] left-[60%] -translate-x-1/2 -translate-y-1/2",
    },
    {
      id: 3,
      text: "To understand how your business works, resolve bottlenecks, and accelerate business deliveries",
      position: "top-[30%] left-[80%] -translate-x-1/2 -translate-y-1/2",
    },
  ];

  return (
    <div className="hidden lg:block relative w-screen h-screen">
      {dots.map((dot) => (
        <div
          key={dot.id}
